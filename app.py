...
class MediaPlayer_GestureRecognition:
    ...
    __FRAME_NAME = "Gesture Control By ~ Tharuneshwar"
    ...
    def start(self):
        ...
        while self.__START_CAM:
            ...
            except AttributeError as e:print("[!] Connect webcam....") ;sys.e   
            ...
            if len(__PTLIST) != 0 and __RESULT.multi_handedness[0].classification[0].index == self.__RIGHT_HAND_INDEX:
                ...
                #""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
                print(f"[~](LOG): FINGER UP/DOWN: {__IS_FINGER_DOWN}, AREA: {__BBOX}, DEGREE: {__HAND_DEGREE} LAST ACTION: {self.__CURRENT_ACTION}")
                #"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
